...
class ASPP(nn.Module):
    ...
    def __init__(self, C, depth, num_classes, conv=nn.Conv2d, norm=nn.BatchNorm2d, momentum=0.0003, mult=2/3):
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes, num_groups=None, weight_std=False, beta=False):
        ...
        self.convUP3 = nn.Conv2d(512, 256, kernel_size=3, stride=1, padding = 1, bias=False)
        self.bnUP3 = self.norm(256)
        self.convUP4 = nn.Conv2d(256, 6, kernel_size=1, stride=1, bias=False)
