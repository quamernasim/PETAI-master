...
class ASPP(nn.Module):
    ...
    def __init__(self, C, depth, num_classes, conv=nn.Conv2d, norm=nn.BatchNorm2d, momentum=0.0003, mult=1):
        ...
        self.conv2 = conv(depth * 5, 512, kernel_size=1, stride=1,
                               bias=False)
        self.bn2 = norm(512, momentum)
        self.conv3 = nn.Conv2d(512, 294, kernel_size=1, stride=1)
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes, num_groups=None, weight_std=False, beta=False):
        ...
        self.conv2 = nn.Conv2d(512, 512, kernel_size=1, stride=1, bias=False)
        self.bn2 = self.norm(512)

        self.pixelshuffle = torch.nn.PixelShuffle(7)
