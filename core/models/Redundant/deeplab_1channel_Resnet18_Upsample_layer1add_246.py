...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes, num_groups=None, weight_std=False, beta=False):
        ...
        self.conv_low_level = nn.Conv2d(256, 256, kernel_size=1, stride=1, bias=False)
        self.bn_low_level = self.norm(256)
        
        self.convUP2 = nn.Conv2d(1280, 256, kernel_size=1, stride=1, bias=False)
        self.bnUP2 = self.norm(256)
